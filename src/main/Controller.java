...
public class Controller {
	...
	public void registerTrainer(ArrayList<Trainer> list) {
	...
	public void FirePokemon(FirePokemon getEnemey, Pokemon get) {
		...
		if (random <= 5) {
			...
			System.out.println("Enemey Attack   : " + (getEnemey.getAtt() * getEnemey.lvl) * 0.8);
			...
			System.out.println("====================");
			System.out.println("Enemey          : " + getEnemey.getName());
			System.out.println("Enemey Attack   : " + (getEnemey.getAtt() * getEnemey.lvl) * 1.6);
			System.out.print("Enemey Skill    : ");
			getEnemey.Skill();
	...
	public void WaterPokemon(WaterPokemon getEnemey, Pokemon get) {
		...
		if (random <= 5) {
			...
			System.out.println("====================");
			System.out.println("Enemey          : " + getEnemey.getName());
			System.out.println("Enemey Attack   : " + (getEnemey.getAtt() * getEnemey.lvl) * 1.7);
			System.out.print("Enemey Skill    : ");
			getEnemey.Skill();
			...
			System.out.println("====================");
			System.out.println("Enemey          : " + getEnemey.getName());
			System.out.println("Enemey Attack   : " + (getEnemey.getAtt() * getEnemey.lvl) * 1.9);
			System.out.print("Enemey Skill    : ");
			getEnemey.Skill();
	...
	public void HealPokemon(Trainer trainer) {
		...
		int idx = -1;
		do {
			System.out.print("Input pokemon name to heal : ");
			name = scan.nextLine();
			idx = valid.checkHeal(name, list);
		} while (idx == -1);
		Pokemon x = list.get(idx);
		x.setHp(ran.nextInt(31)+1);
